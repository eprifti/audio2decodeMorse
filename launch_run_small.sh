#!/usr/bin/env bash
# End-to-end helper for the small LSTM baseline.
# Usage: ./launch_run_small.sh [run_name]
set -euo pipefail
...
RUN_NAME="${1:-baseline_small_cnn2_lstm128_$(date +%Y%m%d_%H%M%S)}"
GEN_CFG="config/generation.yaml"
TRAIN_CFG="config/baseline_small_cnn2_lstm128.yaml"
